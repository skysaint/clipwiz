...
const Entry kDefaults[] = {
    ...
    {"conflict.title", L"Clipboard History Conflict"},
    {"conflict.user_dir", L"User directory"},
    {"conflict.prog_dir", L"Program directory"},
    {"conflict.items", L"items"},
    {"conflict.pinned", L"pinned"},
    {"conflict.use_left", L"Use user directory data"},
    {"conflict.use_right", L"Use program directory data"},
    {"conflict.merge", L"Merge both (auto dedup)"},
